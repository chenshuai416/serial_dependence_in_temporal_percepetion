...
for Block =1 : NumBlocks
    ...
    text1 = strcat('Your accuracy in practice: ',num2str(100-acc),'%');
    ...
    if ~Exit && Block < NumBlocks
        ...
        text2 = 'Practice finished. Press Spacebar to exit... ';
        Screen('DrawText', wPtr, text2,Cen_X-300,Cen_Y,Grey+[255 255 255].*acc/100);
        Screen('Flip',wPtr);
        WaitSecs(1)
    end
